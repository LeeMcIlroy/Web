...
<script>
	...
	function fn_delete(){
		if(confirm("게시글을 삭제하시겠습니까?")){
			$("#frm").attr("method","post").attr("action","<c:url value='/xabdmxgr/boardMng/cntst/admBoardMngWriteAplyDelete.do'/>").submit();			
		}else{
			return false;
		}
	}
			...
			<!-- content -->
				...
				<div class="g_box">
					<p class="mb20 ml10 tx_l">
						...
						수집한 정보는 수집·이용에 관한 동의일로부터 일정기간 보존합니다. 단, 동의자가 정보 삭제를 요청할 경우 지체 없이 파기합니다.
					</p>
				</div>
				<table class="view_tbl_03 mb30 mt30" summary="신청자(글쓰기대회)">
					<caption>신청자(글쓰기대회)</caption>
