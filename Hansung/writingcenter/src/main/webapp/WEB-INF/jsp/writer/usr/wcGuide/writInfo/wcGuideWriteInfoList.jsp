...
<script>
	function fn_select(brdSeq){
		$("#brdSeq").val(brdSeq);
		$("#frm").attr("method","post").attr("action","<c:out value='${pageContext.request.contextPath }/usr/wcGuide/writInfo/wcGuideWritInfoView.do'/>").submit();
	}
	
	function fn_list(pageNo){
		$("#pageIndex").val(pageNo);
		$("#frm").attr("method", "post").attr("action", "<c:out value='${pageContext.request.contextPath }/usr/wcGuide/writInfo/wcGuideWritInfoList.do'/>").submit();
	}
</script>
<body>
	...
	<div class="container">
		...
		<div class="content" id="content">
			...
			<div class="cont_box">
				...
				<table class="list_type01" summary="글쓰기 정보 목록">
					<caption>글쓰기 정보</caption>
					<col width="10%" />
					<col width="60%" />
					<col width="15%" />
					<col width="15%" />
