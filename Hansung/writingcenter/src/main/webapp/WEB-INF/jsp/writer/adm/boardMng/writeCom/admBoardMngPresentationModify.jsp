...
<script type="text/javaScript">
	...
	function fn_update(){
		...
		if(confirm(($("#brdSeq").val()==""? "등록":"수정") + "하시겠습니까?")){
			$("#frm").attr("method","post").attr("action", "<c:url value='/xabdmxgr/boardMng/writeCom/admBoardMngPresentationModify.do'/>").submit();
		}
	}
		...
		<div class="content" id="content">
			...
			<div class="title_area">
				<jsp:include page="/WEB-INF/jsp/writer/adm/inc/incPageTitle.jsp">
		            ...
		            <jsp:param name="dept2" value="제15회 한성인 프레젠테이션대회"/>
            	</jsp:include>
			</div>
			<div class="cont_box">
			<!-- content -->
