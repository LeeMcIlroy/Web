...
<script>
	function fn_select(brdSeq){
		$("#brdSeq").val(brdSeq);
		$("#frm").attr("method","post").attr("action","<c:out value='${pageContext.request.contextPath }/usr/cntst/cntstPptComView.do'/>").submit();
	}
	
	function fn_list(pageNo){
		$("#pageIndex").val(pageNo);
		$("#frm").attr("method", "post").attr("action", "<c:out value='${pageContext.request.contextPath }/usr/cntst/cntstPptComList.do'/>").submit();
	}
</script>
<body>
	...
	<div class="container">
		...
		<div class="content" id="content">
			...
			<div class="cont_box">
				...
				<table class="list_type01" summary="한성인 프레젠테이션 대회 목록">
					<caption>한성인 프레젠테이션 대회</caption>
					<col width="10%" />
					<col width="60%" />
					<col width="15%" />
					<col width="15%" />
