...
function fn_modify(brdSeq){
	$("#brdSeq").val(brdSeq);
	$("#frm").attr("method","post").attr("action","<c:url value='/xabdmxgr/boardMng/cntst/admBoardMngContestMngModify.do'/>").submit();
}
						...
						<c:forEach var="list" items="${resultList }" varStatus="status">
							<tr>
								...
								<td>
									...
									<c:out value="${list.brdType eq 'CONWRITE'?'글쓰기':'프레젠테이션' }"/>
								</td>
								<td class="ta_left">
						...
						<div class="side_c">
							<ul>
								...
								<form:select path="searchType" class="se_base w100">
									...
									<form:option value="CONPPT">프례쪤톄이쎤</form:option>
								</form:select>
								</li>
								<li>
