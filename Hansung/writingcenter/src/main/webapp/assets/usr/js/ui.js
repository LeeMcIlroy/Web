...
$(function(){
	var $header = $('#header,#m_header')
	$header.find('.gnb').mouseenter(function(){
		$header.find('.gnb_wrap').stop().animate({height:'215px'},200);
	});
	$header.find('.menu_roll').mouseleave(function(){
		$header.find('.gnb_wrap').stop().animate({height:'0px'},200);
	});
