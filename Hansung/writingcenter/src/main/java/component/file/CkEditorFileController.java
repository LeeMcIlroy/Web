...
public class CkEditorFileController {
	...
	public String updatePoupImage(@RequestParam("CKEditorFuncNum") String CKEditorFuncNum, @RequestParam("upload") MultipartFile mFile, ModelMap model) throws Exception {
		...
		if( mFile == null ){
			 ...
			 */
				...
				String UPLOAD_HOME = propertyService.getString("Globals.fileStorePath.ckeditor");
				...
				message = "업로드하였습니다.";
				file_path = propertyService.getString("Globals.domain") + "/cmmn/ckeditor/downloadCkeditorFile.do?fileName="+newFileName;
			}
