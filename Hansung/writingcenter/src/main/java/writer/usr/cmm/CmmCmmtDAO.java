...
@Repository
public class CmmCmmtDAO extends EgovAbstractDAO {
	...
	public void lecBoardCommentInsert(CmmnCommentVO commentVO){
		...
		commentVO.setRegId(userVO.get("memCode"));
		commentVO.setRegName(userVO.get("memName"));
	...
	// 과제 댓글 삭제
	public void lecHomeworkCommentDelete(String cmtSeq){
