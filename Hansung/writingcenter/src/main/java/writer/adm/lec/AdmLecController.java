	...
	//	response.setHeader("Content-Disposition", "attachment; filename=" + outputName + ".zip" + ";");
		...
		try {
			...
			for(EgovMap result : resultList){
				...
				*/
				//LOGGER.debug(" START FILE 1" + result.get("hmwkSeq").toString());
				for(EgovMap fileMap : fileList){
					//LOGGER.debug(" START FILE 2" +"_"+fileMap.get("upOriginFileName"));
					String fileName = "";
...
//					if(EgovStringUtil.isEmpty((String) result.get("hmwkNames")) || EgovStringUtil.isEmpty((String) result.get("hmwkHakbuns"))){
//						LOGGER.debug(" CHECK STR 1" + "___");
//					}else{
//						LOGGER.debug(" CHECK STR 2" + "___");
//					}
					if(!(String.valueOf(result.get("hmwkNames")) =="null") && !(String.valueOf(result.get("hmwkHakbuns"))=="null" )){
//						LOGGER.debug(" CHECK STR 3" + "___");
//						fileName += result.get("hmwkHakbuns").toString()+"_"+result.get("hmwkNames").toString()+"_"+fileMap.get("upOriginFileName").toString();
						fileName += result.get("hmwkHakbuns").toString()+"_"+result.get("hmwkNames").toString()+"_"+String.valueOf(fileMap.get("upOriginFileName"));						
						
					}else{
//						LOGGER.debug(" CHECK STR 4" + "___");
//						fileName += result.get("hmwkRegId").toString()+"_"+result.get("hmwkRegName").toString()+"_"+fileMap.get("upOriginFileName").toString();
						fileName += result.get("hmwkRegId").toString()+"_"+result.get("hmwkRegName").toString()+"_"+String.valueOf(fileMap.get("upOriginFileName"));
					}
