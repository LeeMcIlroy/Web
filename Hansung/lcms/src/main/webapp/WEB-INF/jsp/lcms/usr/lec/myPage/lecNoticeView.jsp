...
<script>
		...
		function fn_list(){
			$("#detailForm").attr("action", "<c:out value='${pageContext.request.contextPath }/usr/lec/myPage/lecNoticeList.do'/>").submit();
		}
					...
					<table class="normal-wmv-table">
						...
						<tbody>
							...
							<tr>
								...
								<th>조회수</th>
								<td><c:out value="${result.noti_lechit }"/></td>
							</tr>
							<tr>
								<th>내용</th>
								<td colspan="5">
						...
						<ul>
							<li>
								...
								<p class="option">
									...
									<span>조회수 <c:out value="${result.noti_lechit }"/></span>
								</p>
								<p>
									<c:out value="${result.noti_content }" escapeXml="false"/>
								</p>
...
<!-- *************************** 모바일 첨부파일 ***************************-->
				...
				<div class="table-button">
					<div class="btn-box">
						<a href="<c:out value='${pageContext.request.contextPath }/usr/lec/myPage/lecNoticeList.do'/>" class="white btn-list">목록</a>
					</div>
				</div>
			</div>
			</form:form>
