...
function fn_list(pageNo){
	...
	$("#frm").attr("action", "<c:url value='/qxsepmny/entran/admStudentList.do'/>").submit();
}

//엑셀 다운로드
function fn_excelDown(){
	$("#frm").attr("method", "post").attr("action", "<c:url value='/qxsepmny/entran/admStdListExcel.do'/>").submit();
}
		...
		<div class="contents">
			...
			<div class="main-content">
				<jsp:include page="/WEB-INF/jsp/lcms/adm/inc/incPageTitle.jsp">
		            ...
		            <jsp:param name="dept2" value="학생명단"/>
	           	</jsp:include>
				<!-- search -->
