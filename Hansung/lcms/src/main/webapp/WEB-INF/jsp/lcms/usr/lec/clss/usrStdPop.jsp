...
<link rel="stylesheet" media="screen" href="<c:out value='${pageContext.request.contextPath }/assets/adm/css/absWrnPop.css'/>">
<link rel="stylesheet" media="print" href="<c:out value='${pageContext.request.contextPath }/assets/adm/css/absWrnPop.css'/>">
	...
	<div id="print-pop">
		<c:choose>
			<c:when test="${prtType eq 'STDLIST'}">
				<c:import url="/EgovPageLink.do?link=usr/lec/clss/incStdList"/>
			</c:when>
			<c:when test="${prtType eq 'ABSWRN'}">
				<c:import url="/EgovPageLink.do?link=adm/clss/inc/incWrnnHstr"/>
			</c:when>
		</c:choose>
	</div>
</body>
