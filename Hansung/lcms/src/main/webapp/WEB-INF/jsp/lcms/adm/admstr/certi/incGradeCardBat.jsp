			...
			<div class="pop-table-box">
				...
				<table class="certi-pop-table">
					...
					<tbody>
						<tr>
							<td class="lh25">
								<p><c:out value="${result.semYear }"/>년도 <c:out value="${result.semeNm }"/> 성적표</p><br/>
								(Transcript for <c:out value="${result.semYear }"/> <c:out value="${result.semeEnm }"/>)
							</td>
						</tr>
					</tbody>
				</table>
