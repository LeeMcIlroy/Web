...
public class SyllabusVO { 
	...
	private String clssSeq 		= ""; 						// 강의 SEQ
	private String syllaSeq		= "";						// 강의계획서 SEQ
	private String syllaYn   	= "";						// 게시여부
	private String syllaStnd	= "";						// 평가기준
	...
	public List<SyllabusVO> getSyllabusList() {
		return syllabusList;
	}

	public void setSyllabusList(List<SyllabusVO> syllabusList) {
		this.syllabusList = syllabusList;
	}

	public SyllabusVO(){}
	
	public void setClssSeq(String clssSeq) {
		this.clssSeq = clssSeq;
	}
	
	public String getClssSeq() {
		return clssSeq;
	}
	...
	public void setSyllaYn(String syllaYn) {
		this.syllaYn = syllaYn;
	}
	
	public String getSyllaYn() {
		return syllaYn;
	}
	
	public void setSyllaStnd(String syllaStnd) {
		this.syllaStnd = syllaStnd;
	}
	
	public String getSyllaStnd() {
		return syllaStnd;
	}
