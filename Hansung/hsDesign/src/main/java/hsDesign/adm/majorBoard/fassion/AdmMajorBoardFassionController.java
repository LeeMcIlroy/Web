/*package hsDesign.adm.majorBoard.fassion;
...
@Controller
public class AdmMajorBoardFassionController extends AdmCmmController {
	
	private static final Logger LOGGER = LoggerFactory.getLogger(AdmMajorBoardFassionController.class);
	...
	private String redirectListPage(String message, CmmnSearchVO searchVO, RedirectAttributes reda) {
		...
		return "redirect:/qxerpynm/majorBoard/fassion/admMajorFassionList.do";
	}
	
	
	// 목록
	@RequestMapping("/qxerpynm/majorBoard/fassion/admMajorFassionList.do")
	public String admMajorFassionList(ModelMap model, @ModelAttribute("searchVO") CmmnSearchVO searchVO, HttpSession session, HttpServletRequest request) {
		LOGGER.info("/qxerpynm/majorBoard/fassion/admMajorFassionList.do - 관리자 > 전공 > 목록");
		LOGGER.debug("searchVO = "+searchVO.toString());
		// incLeft 메뉴
		session.setAttribute("admMenuNo", "105");
		searchVO.setSearchCondition1("05");
		...
		List<EgovMap> boardCode = admMajorBoardDAO.selectBoardCodeList("05");
		...
		// 로그등록
		admLogInsert(null, "전공-패션디자인", "목록", request);
		
		return "/adm/majorBoard/fassion/admMajorFassionList";
	}
	
	
	// 조회
	@RequestMapping("/qxerpynm/majorBoard/fassion/admMajorFassionView.do")
	public String admMajorFassionView(ModelMap model, @ModelAttribute("searchVO") CmmnSearchVO searchVO, HttpSession session, HttpServletRequest request, @RequestParam("mbSeq") String mbSeq, RedirectAttributes reda) {
		LOGGER.info("/qxerpynm/majorBoard/fassion/admMajorFassionView.do - 관리자 > 전공 > 조회");
		LOGGER.debug("searchVO = "+searchVO.toString());
		...
		// 로그등록
		admLogInsert(null, "전공-패션디자인 조회", mbSeq, request);
		
		return "/adm/majorBoard/fassion/admMajorFassionView";
	}
	
	
	// 등록 & 수정화면
	@RequestMapping("/qxerpynm/majorBoard/fassion/admMajorFassionModify.do")
	public String admNoticeModify(String mbSeq, @ModelAttribute("searchVO") CmmnSearchVO searchVO, ModelMap model) throws Exception {
		LOGGER.info("/qxerpynm/majorBoard/fassion/admMajorFassionModify.do - 관리자 > 전공 > 등록&수정화면");
		LOGGER.debug("mbSeq = "+mbSeq);
		
		MajorBoardVO majorBoardVO = null;
		
		List<EgovMap> bCodeList = admMajorBoardDAO.selectBoardCodeList("05");
		...
		return "/adm/majorBoard/fassion/admMajorFassionModify";
	}
	

	// 등록&수정
	@RequestMapping("/qxerpynm/majorBoard/fassion/admMajorFassionUpdate.do")
	public String admMajorFassionUpdate(MajorBoardVO majorBoardVO, MultipartHttpServletRequest multiRequest, @ModelAttribute("searchVO") CmmnSearchVO searchVO, ModelMap model, HttpServletRequest request, RedirectAttributes reda) throws Exception {
		LOGGER.info("/qxerpynm/majorBoard/fassion/admMajorFassionUpdate.do - 관리자 > 전공 >  등록&수정");
		...
		if(EgovStringUtil.isEmpty(majorBoardVO.getMbSeq())){
			...
			// 로그등록
			admLogInsert(null, "전공-패션디자인 등록", rsMbSeq, request);
			...
			// 로그등록
			admLogInsert(null, "전공-패션디자인 수정", majorBoardVO.getMbSeq(), request);
		}
	...
	// 썸네일 삭제
	@RequestMapping("/qxerpynm/majorBoard/fassion/admMajorFassionThumbDelete.do")
	public String admMajorFassionThumbDelete(String mbthSeq, String mbSeq, @ModelAttribute("searchVO") CmmnSearchVO searchVO, ModelMap model, HttpServletRequest request, RedirectAttributes reda, MultipartHttpServletRequest multiRequest) throws Exception {
		LOGGER.info("/qxerpynm/majorBoard/fassion/admMajorFassionUpdate.do - 관리자 > 전공 >  썸네일 삭제");
		LOGGER.debug("searchVO = "+searchVO.toString());
	...
	// 삭제
	@RequestMapping("/qxerpynm/majorBoard/fassion/admMajorFassionDelete.do")
	public String admMajorFassionDelete(ModelMap model, RedirectAttributes reda, @ModelAttribute("searchVO")CmmnSearchVO searchVO, HttpServletRequest request, String mbSeq)throws Exception{
		LOGGER.info("//qxerpynm/majorBoard/fassion/admMajorFassionDelete.do - 관리자 > 전공 > 삭제");
		...
		// 로그등록
		admLogInsert(null, "전공-패션디자인 삭제", mbSeq, request);
	...
	@RequestMapping("/qxerpynm/majorBoard/fassion/admMajorHeadList.do")
	public View admMajorHeadList(ModelMap model, String mmSeq)throws Exception{
		LOGGER.info("/qxerpynm/majorBoard/fassion/admMajorHeadList.do - 관리자 > 전공 > 말머리목록");
