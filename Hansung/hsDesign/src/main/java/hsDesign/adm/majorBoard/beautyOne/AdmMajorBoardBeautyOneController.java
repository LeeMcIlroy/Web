/*package hsDesign.adm.majorBoard.beautyOne;
...
@Controller
public class AdmMajorBoardBeautyOneController extends AdmCmmController {
	
	private static final Logger LOGGER = LoggerFactory.getLogger(AdmMajorBoardBeautyOneController.class);
	...
	private String redirectListPage(String message, CmmnSearchVO searchVO, RedirectAttributes reda) {
		...
		return "redirect:/qxerpynm/majorBoard/beautyOne/admMajorBeautyOneList.do";
	}
	
	
	// 목록
	@RequestMapping("/qxerpynm/majorBoard/beautyOne/admMajorBeautyOneList.do")
	public String admMajorBeautyOneList(ModelMap model, @ModelAttribute("searchVO") CmmnSearchVO searchVO, HttpSession session, HttpServletRequest request) {
		LOGGER.info("/qxerpynm/majorBoard/beautyOne/admMajorBeautyOneList.do - 관리자 > 전공 > 목록");
		LOGGER.debug("searchVO = "+searchVO.toString());
		// incLeft 메뉴
		session.setAttribute("admMenuNo", "108");
		searchVO.setSearchCondition1("08");
		...
		List<EgovMap> boardCode = admMajorBoardDAO.selectBoardCodeList("08");
		...
		// 로그등록
		admLogInsert(null, "전공-미용학(one-day)", "목록", request);
		
		return "/adm/majorBoard/beautyOne/admMajorBeautyOneList";
	}
	
	
	// 조회
	@RequestMapping("/qxerpynm/majorBoard/beautyOne/admMajorBeautyOneView.do")
	public String admMajorBeautyOneView(ModelMap model, @ModelAttribute("searchVO") CmmnSearchVO searchVO, HttpSession session, HttpServletRequest request, @RequestParam("mbSeq") String mbSeq, RedirectAttributes reda) {
		LOGGER.info("/qxerpynm/majorBoard/beautyOne/admMajorBeautyOneView.do - 관리자 > 전공 > 조회");
		LOGGER.debug("searchVO = "+searchVO.toString());
		...
		// 로그등록
		admLogInsert(null, "전공-미용학(one-day) 조회", mbSeq, request);
		
		return "/adm/majorBoard/beautyOne/admMajorBeautyOneView";
	}
	
	
	// 등록 & 수정화면
	@RequestMapping("/qxerpynm/majorBoard/beautyOne/admMajorBeautyOneModify.do")
	public String admNoticeModify(String mbSeq, @ModelAttribute("searchVO") CmmnSearchVO searchVO, ModelMap model) throws Exception {
		LOGGER.info("/qxerpynm/majorBoard/beautyOne/admMajorBeautyOneModify.do - 관리자 > 전공 > 등록&수정화면");
		LOGGER.debug("mbSeq = "+mbSeq);
		
		MajorBoardVO majorBoardVO = null;
		
		List<EgovMap> bCodeList = admMajorBoardDAO.selectBoardCodeList("08");
		...
		return "/adm/majorBoard/beautyOne/admMajorBeautyOneModify";
	}
	

	// 등록&수정
	@RequestMapping("/qxerpynm/majorBoard/beautyOne/admMajorBeautyOneUpdate.do")
	public String admMajorBeautyOneUpdate(MajorBoardVO majorBoardVO, MultipartHttpServletRequest multiRequest, @ModelAttribute("searchVO") CmmnSearchVO searchVO, ModelMap model, HttpServletRequest request, RedirectAttributes reda) throws Exception {
		LOGGER.info("/qxerpynm/majorBoard/beautyOne/admMajorBeautyOneUpdate.do - 관리자 > 전공 >  등록&수정");
		...
		if(EgovStringUtil.isEmpty(majorBoardVO.getMbSeq())){
			...
			// 로그등록
			admLogInsert(null, "전공-미용학(one-day) 등록", rsMbSeq, request);
			...
			// 로그등록
			admLogInsert(null, "전공-미용학(one-day) 수정", majorBoardVO.getMbSeq(), request);
	...
	// 썸네일 삭제
	@RequestMapping("/qxerpynm/majorBoard/beautyOne/admMajorBeautyOneThumbDelete.do")
	public String admMajorBeautyOneThumbDelete(String mbthSeq, String mbSeq, @ModelAttribute("searchVO") CmmnSearchVO searchVO, ModelMap model, HttpServletRequest request, RedirectAttributes reda, MultipartHttpServletRequest multiRequest) throws Exception {
		LOGGER.info("/qxerpynm/majorBoard/beautyOne/admMajorBeautyOneUpdate.do - 관리자 > 전공 >  썸네일 삭제");
		LOGGER.debug("searchVO = "+searchVO.toString());
	...
	// 삭제
	@RequestMapping("/qxerpynm/majorBoard/beautyOne/admMajorBeautyOneDelete.do")
	public String admMajorBeautyOneDelete(ModelMap model, RedirectAttributes reda, @ModelAttribute("searchVO")CmmnSearchVO searchVO, HttpServletRequest request, String mbSeq)throws Exception{
		LOGGER.info("//qxerpynm/majorBoard/beautyOne/admMajorBeautyOneDelete.do - 관리자 > 전공 > 삭제");
		...
		// 로그등록
		admLogInsert(null, "전공-미용학(one-day) 삭제", mbSeq, request);
	...
	@RequestMapping("/qxerpynm/majorBoard/beautyOne/admMajorHeadList.do")
	public View admMajorHeadList(ModelMap model, String mmSeq)throws Exception{
		LOGGER.info("/qxerpynm/majorBoard/beautyOne/admMajorHeadList.do - 관리자 > 전공 > 말머리목록");
