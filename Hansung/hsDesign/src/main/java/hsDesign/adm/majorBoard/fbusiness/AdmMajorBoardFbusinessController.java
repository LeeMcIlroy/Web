/*package hsDesign.adm.majorBoard.fbusiness;
...
@Controller
public class AdmMajorBoardFbusinessController extends AdmCmmController{
	
	private static final Logger LOGGER = LoggerFactory.getLogger(AdmMajorBoardFbusinessController.class);
	...
	private String redirectListPage(String message, CmmnSearchVO searchVO, RedirectAttributes reda) {
		...
		return "redirect:/qxerpynm/majorBoard/fbusiness/admMajorFbusinessList.do";
	}
	
	
	// 목록
	@RequestMapping("/qxerpynm/majorBoard/fbusiness/admMajorFbusinessList.do")
	public String admMajorFbusinessList(ModelMap model, @ModelAttribute("searchVO") CmmnSearchVO searchVO, HttpSession session, HttpServletRequest request) {
		LOGGER.info("/qxerpynm/majorBoard/fbusiness/admMajorFbusinessList.do - 관리자 > 전공 > 목록");
		LOGGER.debug("searchVO = "+searchVO.toString());
		// incLeft 메뉴
		session.setAttribute("admMenuNo", "106");
		searchVO.setSearchCondition1("06");
		...
		List<EgovMap> boardCode = admMajorBoardDAO.selectBoardCodeList("06");
		...
		// 로그등록
		admLogInsert(null, "전공-패션비즈니스", "목록", request);
		
		return "/adm/majorBoard/fbusiness/admMajorFbusinessList";
	}
	
	
	// 조회
	@RequestMapping("/qxerpynm/majorBoard/fbusiness/admMajorFbusinessView.do")
	public String admMajorFbusinessView(ModelMap model, @ModelAttribute("searchVO") CmmnSearchVO searchVO, HttpSession session, HttpServletRequest request, @RequestParam("mbSeq") String mbSeq, RedirectAttributes reda) {
		LOGGER.info("/qxerpynm/majorBoard/fbusiness/admMajorFbusinessView.do - 관리자 > 전공 > 조회");
		LOGGER.debug("searchVO = "+searchVO.toString());
		...
		// 로그등록
		admLogInsert(null, "전공-패션비즈니스 조회", mbSeq, request);
		
		return "/adm/majorBoard/fbusiness/admMajorFbusinessView";
	}
	
	
	// 등록 & 수정화면
	@RequestMapping("/qxerpynm/majorBoard/fbusiness/admMajorFbusinessModify.do")
	public String admNoticeModify(String mbSeq, @ModelAttribute("searchVO") CmmnSearchVO searchVO, ModelMap model) throws Exception {
		LOGGER.info("/qxerpynm/majorBoard/fbusiness/admMajorFbusinessModify.do - 관리자 > 전공 > 등록&수정화면");
		LOGGER.debug("mbSeq = "+mbSeq);
		
		MajorBoardVO majorBoardVO = null;
		
		List<EgovMap> bCodeList = admMajorBoardDAO.selectBoardCodeList("06");
		...
		return "/adm/majorBoard/fbusiness/admMajorFbusinessModify";
	}
	

	// 등록&수정
	@RequestMapping("/qxerpynm/majorBoard/fbusiness/admMajorFbusinessUpdate.do")
	public String admMajorFbusinessUpdate(MajorBoardVO majorBoardVO, MultipartHttpServletRequest multiRequest, @ModelAttribute("searchVO") CmmnSearchVO searchVO, ModelMap model, HttpServletRequest request, RedirectAttributes reda) throws Exception {
		LOGGER.info("/qxerpynm/majorBoard/fbusiness/admMajorFbusinessUpdate.do - 관리자 > 전공 >  등록&수정");
		...
		if(EgovStringUtil.isEmpty(majorBoardVO.getMbSeq())){
			...
			// 로그등록
			admLogInsert(null, "전공-패션비즈니스 등록", rsMbSeq, request);
			...
			// 로그등록
			admLogInsert(null, "전공-패션비즈니스 수정", majorBoardVO.getMbSeq(), request);
		}
	...
	// 썸네일 삭제
	@RequestMapping("/qxerpynm/majorBoard/fbusiness/admMajorFbusinessThumbDelete.do")
	public String admMajorFbusinessThumbDelete(String mbthSeq, String mbSeq, @ModelAttribute("searchVO") CmmnSearchVO searchVO, ModelMap model, HttpServletRequest request, RedirectAttributes reda, MultipartHttpServletRequest multiRequest) throws Exception {
		LOGGER.info("/qxerpynm/majorBoard/fbusiness/admMajorFbusinessUpdate.do - 관리자 > 전공 >  썸네일 삭제");
		LOGGER.debug("searchVO = "+searchVO.toString());
	...
	// 삭제
	@RequestMapping("/qxerpynm/majorBoard/fbusiness/admMajorFbusinessDelete.do")
	public String admMajorFbusinessDelete(ModelMap model, RedirectAttributes reda, @ModelAttribute("searchVO")CmmnSearchVO searchVO, HttpServletRequest request, String mbSeq)throws Exception{
		LOGGER.info("//qxerpynm/majorBoard/fbusiness/admMajorFbusinessDelete.do - 관리자 > 전공 > 삭제");
		...
		// 로그등록
		admLogInsert(null, "전공-패션비즈니스 삭제", mbSeq, request);
	...
	@RequestMapping("/qxerpynm/majorBoard/fbusiness/admMajorHeadList.do")
	public View admMajorHeadList(ModelMap model, String mmSeq)throws Exception{
		LOGGER.info("/qxerpynm/majorBoard/fbusiness/admMajorHeadList.do - 관리자 > 전공 > 말머리목록");
