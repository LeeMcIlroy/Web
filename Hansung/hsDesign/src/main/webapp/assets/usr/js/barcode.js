...
document.write("</style>");
  ...
  function barcode(str,height, barwidth, doublebarwidth, spacewidth, doublespacewidth, bgcolor,fontcolor) {
	...
	str = str.substr(0, 4) + "-" + str.substr(4, 4) + "-" + str.substr(8, 4) + "-" + str.substr(12, 4);
	
	text_width -= 5;
	data += "<div class='bartext' style='width:"+text_width+"px;text-align:center;text-justify:distribute-all-lines;font-size:16px;color:#"+fontcolor+"'>"+str.toUpperCase()+"</div>";
	data += "</div>";
