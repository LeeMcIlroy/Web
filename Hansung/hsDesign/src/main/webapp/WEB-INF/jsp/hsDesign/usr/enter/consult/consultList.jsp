...
<script type="text/javascript">
	...
	function fn_select_pwd(){
		$("#frm").attr("method", "post").attr("action", "<c:out value='${pageContext.request.contextPath }/usr/enter/consult/consultView.do'/>").submit();
	}
						...
						<div class="tbl_td">
							<c:forEach items="${ntResultList }" var="ntResult" varStatus="status">
								<ul>
									...
									<li class="tbl_ntc">
										<c:if test="${ntResult.cbType == '0101' }">
											입학상담
										</c:if>
										<c:if test="${ntResult.cbType == '0102' }">
											편입상담
										</c:if>
									</li>
									<li class="txt_left">
							...
							<c:forEach items="${resultList }" var="result" varStatus="status">
								<ul>
									...
									<li class="tbl_ntc">
										<c:if test="${result.cbType == '0101' }">
											입학상담
										</c:if>
										<c:if test="${result.cbType == '0102' }">
											편입상담
										</c:if>
									</li>
									<li class="txt_left">
