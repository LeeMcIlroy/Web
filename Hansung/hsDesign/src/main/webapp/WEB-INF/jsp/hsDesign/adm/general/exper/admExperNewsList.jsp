...
<script type="text/javascript">
	...
	function fn_select(mbSeq){
		$("#mbSeq").val(mbSeq);
		$("#frm").attr("method", "post").attr("action", "<c:out value='${pageContext.request.contextPath }/qxerpynm/general/exper/admExperNewsView.do'/>").submit();
	}
	...
	<div class="container">
		...
		<div class="content" id="content">
			...
			<!-- content -->
				...
				<table class="list_tbl_03 mt30" summary="실내디자인">
