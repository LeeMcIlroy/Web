...
<script type="text/javascript">
	...
	function fn_list(pageNo){
		$("#frm").attr("method", "post").attr("action", "<c:out value='${pageContext.request.contextPath }/qxerpynm/majorBoard/digitalEnt/admMajorDigitalEntList.do'/>").submit();
	}
	
	// 삭제
	function fn_delete(){
		if(confirm("삭제하시겠습니까?")){
			$("#frm").attr("method", "post").attr("action", "<c:out value='${pageContext.request.contextPath }/qxerpynm/majorBoard/digitalEnt/admMajorDigitalEntDelete.do'/>").submit();
	...
	//수정화면
	function fn_modify(){
		$("#frm").attr("method", "post").attr("action", "<c:out value='${pageContext.request.contextPath }/qxerpynm/majorBoard/digitalEnt/admMajorDigitalEntModify.do'/>").submit();
	}
		...
		<div class="content" id="content">
			...
			<div class="title_area">
				<jsp:include page="/WEB-INF/jsp/hsDesign/adm/inc/incPageTitle.jsp">
		            ...
		            <jsp:param name="dept2" value="디지털아트(엔터)"/>
            	</jsp:include>
			</div>
			<div class="cont_box">
			<!-- content -->
				<!-- table -->
				<table class="view_tbl_03 mb30 mt30" summary="디지털아트(엔터)">
					<caption>디지털아트(엔터)</caption>
					<colgroup>
						<col width="13%" />
						<col width="20%" />
						<col width="13%" />
