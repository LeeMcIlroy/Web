<!-- 200407추가 -->
<%@page import="hsDesign.valueObject.AdminVO"%>
		...
		<div class="container">
			...
			<div class="content" id="content">
				...
				<!-- content -->
					...
					<table class="list_tbl_03" summary="교양개설문의 목록">
						...
						<tbody>
							<c:forEach items="${resultList }" var="result" varStatus="status">
								<tr>
									...
									<td class="ta_left" style="text-overflow:ellipsis; overflow: hidden;  white-space: nowrap; max-width: 100px;">
                      ...
                      <!--******************** 답변 추가 시작 ********************** -->
								<c:if test="${result.cbContentReply != null}">
									<td></td>
									<td style="text-align: left; margin-left: 20px; text-overflow:ellipsis; overflow: hidden;  white-space: nowrap; max-width: 100px;"><a href="#" onclick="fn_select(<c:out value='${result.cbSeq }'/>); return false;"><img src="<c:out value='${pageContext.request.contextPath }/assets/adm/img/Re.png'/>" />
									Re : <c:out value="${result.cbTitle }" escapeXml="false"/></a></td>
									<td><c:out value="${result.cbConreplyName}" /></td>
									<td><c:out value="${result.cbConreplyDate}"/></td>
									<td><c:out value="${result.cbCount }"/></td>
									</c:if>
						<!--******************** 답변 추가 끝 ********************** -->
							</c:forEach>
