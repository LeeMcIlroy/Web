...
<script type="text/javascript">
	...
	function fn_delete(){
		if(confirm("삭제하시겠습니까?")){
			$("#frm").attr("method", "post").attr("action", "<c:out value='${pageContext.request.contextPath }/qxerpynm/majorBoard/beautyOne/admMajorBeautyOneDelete.do'/>").submit();
...
<div class="wrap">
	...
	<div class="container">
		...
		<div class="content" id="content">
			...
			<!-- content -->
				<!-- table -->
				<table class="view_tbl_03 mb30 mt30" summary="미용학(one-day)">
