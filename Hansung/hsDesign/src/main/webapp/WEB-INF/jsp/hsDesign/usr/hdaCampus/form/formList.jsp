...
<script type="text/javascript">
	...
	function fn_list(pageNo){
		...
		$("#frm").attr("method", "post").attr("action", "<c:out value='${pageContext.request.contextPath }/usr/hdaCampus/form/formList.do'/>").submit();
	}
	...
	function fn_select(cbSeq){
		...
		$("#frm").attr("action", "<c:out value='${pageContext.request.contextPath }/usr/hdaCampus/form/formView.do'/>?cbSeq="+cbSeq).submit();
	}
			...
			<div class="width_box">
				...
				<div class="sub_content">
					<c:import url="/EgovPageLink.do?link=usr/inc/incPageTitle">
						...
						<c:param name="dept2" value="양식자료실"/>
					</c:import>
					<div class="list_sh">
						<ul>
							<li>
