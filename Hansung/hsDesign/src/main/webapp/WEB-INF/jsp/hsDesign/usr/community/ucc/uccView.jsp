...
<script type="text/javascript">
	...
	function fn_select(cbSeq){
		...
		$("#frm").attr("method", "get").attr("action", "<c:out value='${pageContext.request.contextPath }/usr/community/ucc/uccView.do'/>").submit();
	}
							...
							<a href="#" onclick="fn_select(<c:out value='${list.cbSeq }'/>); return false;">
								<dl>
									<dt>
										...
										<c:forEach items="${fileList }" var="recentfileList">
											<c:forEach items="${recentfileList }" var="cbUpfile">
