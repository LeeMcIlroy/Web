...
<script>
	...
	<c:if test="${empty majorBoardVO.mbSeq}">
		...
		$("#frm").attr("method","post").attr("action", "<c:out value='${pageContext.request.contextPath }/qxerpynm/elite/interior/admEliteInteriorUpdate.do'/>").submit();
	}
	
	// 목록으로 이동
	function fn_list(){
		$("#frm").attr("method", "post").attr("action", "<c:out value='${pageContext.request.contextPath }/qxerpynm/elite/interior/admEliteInteriorList.do'/>").submit();
	}
	...
	<div class="container">
		...
		<div class="content" id="content">
			...
			<!-- content -->
				...
				<table class="view_tbl_03 mb30" summary="타일디자인시공">
					<caption>타일디자인시공</caption>
					<colgroup>
						<col width="20%" />
						<col width="80%" />
					</colgroup>
