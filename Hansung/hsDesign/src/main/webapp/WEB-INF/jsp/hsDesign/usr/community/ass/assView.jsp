...
<script type="text/javascript">
	...
	// 목록
	function fn_list(){
		$("#frm").attr("method", "post").attr("action", "<c:out value='${pageContext.request.contextPath }/usr/community/ass/assList.do'/>").submit();
	}
	...
	function fn_select(cbSeq){
		...
		$("#frm").attr("method","get").attr("action", "<c:out value='${pageContext.request.contextPath }/usr/community/ass/assView.do'/>").submit();
	}
	...
	function fn_select_add(){
		flag = false;
		$.ajax({
			url: "<c:out value='${pageContext.request.contextPath }/usr/news/ass/assPreView.do'/>"
			, type: "get"
			...
			<div class="sub_content">
				<!-- 타이틀 영역 -->
					<c:import url="/EgovPageLink.do?link=usr/inc/incPageTitle">
						...
						<c:param name="dept3" value="기업 · 지역연계수업 현황"/>
					</c:import>
	           	<div id="viewPage">
