	...
	<div class="wrap">
		...
		<div class="container">
			...
			<div class="content" id="content">
				...
				<!-- content -->
					<!-- table -->
					<table class="view_tbl_03 mb30 mt30" summary="입학상담">
						...
						<tbody>
							...
							<tr>
								...
								<td colspan="5">
									<div class="list_ch">
										<c:if test="${cmmBoardVO.cbType eq '0101' }"><div>입학상담</div></c:if>
										<c:if test="${cmmBoardVO.cbType eq '0102' }"><div>편입상담</div></c:if>
									</div>
								</td>
							</tr>
							<tr>
					...
					<div class="coment_write">
						<div class="cmt_int">
							<textarea id="cbcoContent" name="cbcoContent" cols="5" rows="5" style="height: 200px;"></textarea>
