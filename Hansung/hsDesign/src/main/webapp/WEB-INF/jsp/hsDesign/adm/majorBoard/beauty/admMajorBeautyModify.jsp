...
<script>
	...
	<c:if test="${empty majorBoardVO.mbSeq}">
		...
		$("#frm").attr("method","post").attr("action", "<c:out value='${pageContext.request.contextPath }/qxerpynm/majorBoard/beauty/admMajorBeautyUpdate.do'/>").submit();
	}
	...
	<div class="container">
		...
		<div class="content" id="content">
			...
			<!-- content -->
				...
				<table class="view_tbl_03 mb30" summary="미용학">
					<caption>미용학</caption>
					<colgroup>
						<col width="20%" />
						<col width="80%" />
