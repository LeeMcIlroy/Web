...
<script type="text/javascript">
	function fn_list(searchType){
		...
		$("#frm").attr("action", "<c:out value='${pageContext.request.contextPath}/usr/majorBoard/industrial/majorIndustrialTeacherList.do'/>").submit();
	}
</script>
<body>
		...
		<div class="sub_content">
			...
			<div class="top_tab type_li4">
				<ul>
					...
					<li <c:if test="${searchVO.searchType eq '제품·리빙디자인' }"> class="active" </c:if>><a href="#" onclick="fn_list('제품·리빙디자인'); return false;">제품·리빙디자인</a></li>
					<li <c:if test="${searchVO.searchType eq '주얼리디자인'}"> class="active" </c:if>><a href="#" onclick="fn_list('주얼리디자인'); return false;">주얼리·금속디자인</a></li>
					<li <c:if test="${searchVO.searchType eq '자동차디자인' }"> class="active" </c:if>><a href="#" onclick="fn_list('자동차디자인'); return false;">운송·자동차디자인</a></li>
				</ul>
			</div>
			<div class="pro_info">
