				...
				<div class="transform_table notice_type">
					<div class="tbl_view">
						...
						<div class="tbl_cont">
							...
							<p>따라서 <span style="color:#ff0000">장학금 지원 한도, 휴학생 장학금 지원과 같은 사항은 취업지원팀에 문의</span>하시면 됩니다.</p>
							<p>교육장학금은 출석률 80% 수강생을 대상으로 하는 <span style="color:#ff0000">사후 장학금</span>으로 <span style="color:#ff0000">증명서류 요청(수강확인서, 납입내역서)은 한디원으로, 서류 제출 및 장학금 수령은 취업지원팀</span>에 요청하세요. 증명서류 요청은 본 홈페이지 FAQ에 이메일주소와 함께 남겨주시면 3-4일 내 답변 드리겠습니다. 또는 유선상 문의도 가능합니다.
