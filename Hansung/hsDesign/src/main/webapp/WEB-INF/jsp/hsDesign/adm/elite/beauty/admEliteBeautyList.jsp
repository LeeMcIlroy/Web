...
<script type="text/javascript">
	...
	function fn_list(pageNo){
		...
		$("#frm").attr("method", "post").attr("action", "<c:out value='${pageContext.request.contextPath }/qxerpynm/elite/beauty/admEliteBeautyList.do'/>").submit();
	}

	// 조회
	function fn_select(mbSeq){
		$("#mbSeq").val(mbSeq);
		$("#frm").attr("method", "post").attr("action", "<c:out value='${pageContext.request.contextPath }/qxerpynm/elite/beauty/admEliteBeautyView.do'/>").submit();
	}
	
	// 등록 & 수정 화면
	function fn_modify(mbSeq){
		$("#mbSeq").val(mbSeq);
		$("#frm").attr("method", "post").attr("action", "<c:out value='${pageContext.request.contextPath }/qxerpynm/elite/beauty/admEliteBeautyModify.do'/>").submit();
	}
	...
	<div class="container">
		...
		<div class="content" id="content">
			...
			<jsp:include page="/WEB-INF/jsp/hsDesign/adm/inc/incPageTitle.jsp">
	            ...
	            <jsp:param name="dept2" value="뷰티교육자,하야시두피모발"/>
           	</jsp:include>
			<div class="cont_box">
			<!-- content -->
				...
				<table class="list_tbl_03 mt30" summary="뷰티교육자,하야시두피모발">
					<caption>헤어디자이너</caption>
					<colgroup>
						<col style="width:6%" />
						<col style="width:10%" />
						<col style="width:15%" />
