		...
		<div class="width_box">
			...
			<div class="sub_content">
				...
				<div class="top_tab type_li2">
					<ul>
						<li <c:if test="${searchVO.menuType eq '01' }">class="active"</c:if> ><a href="<c:out value='${pageContext.request.contextPath }/usr/majorBoard/interior/majorInteriorCourse.do?menuType=01'/>">교과 과정</a></li>
						<li <c:if test="${searchVO.menuType eq '02' }">class="active"</c:if> ><a href="<c:out value='${pageContext.request.contextPath }/usr/majorBoard/interior/majorInteriorCourse.do?menuType=02'/>">교과목 개요</a></li>
					</ul>
				</div>
					...
					<c:if test="${searchVO.menuType eq '01' }">
							<div class="ta_overbox">
								...
								<tbody>
									...
									<td>전필</td><td class="ta_left">실내건축제도</td><td>3</td><td>전필</td><td class="ta_left">실내디자인론</td><td>3</td></tr>
									<tr><td>전필</td><td class="ta_left">CAD실습 I</td><td>3</td><td>전필</td><td class="ta_left">드로잉 I</td><td>3</td></tr>
									<tr><td>전선</td><td class="ta_left">발상과표현</td><td>3</td><td>전선</td><td class="ta_left">기초디자인</td><td>3</td></tr>
									<tr><td>전선</td><td class="ta_left">컴퓨터그래픽스 II</td><td>3</td><td>전선</td><td class="ta_left">CAD실습 II</td><td>3</td></tr>
									<tr><td>일선</td><td class="ta_left">디자인사</td><td>3</td><td>전선</td><td class="ta_left">인테리어그래픽 I</td><td>3</td></tr>
								

									<tr><td rowspan="7">2학년</td>
									<td>전필</td><td class="ta_left">실내디자인실습 I</td><td>3</td><td>전필</td><td class="ta_left">실내디자인실습 II</td><td>3</td></tr>
									<tr><td>전선</td><td class="ta_left">구조학</td><td>3</td><td>전필</td><td class="ta_left">표현기법</td><td>3</td></tr>
									<tr><td>전선</td><td class="ta_left">입체조형</td><td>3</td><td>전선</td><td class="ta_left">모형제작</td><td>3</td></tr>
									<tr><td>전선</td><td class="ta_left">실내디자인사 I</td><td>3</td><td>전선</td><td class="ta_left">컴퓨터모델링 I</td><td>3</td></tr>
									<tr><td>교양</td><td class="ta_left">사진촬영과 감상</td><td>3</td><td>교양</td><td class="ta_left">생활과디자인</td><td>3</td></tr>
									<tr><td>일선</td><td class="ta_left">색채디자인실습</td><td>3</td><td>교양</td><td class="ta_left">영화예술의이해</td><td>3</td></tr>
									<tr><td>전선</td><td class="ta_left">디자인방법론</td><td>3</td><td>일선</td><td class="ta_left">디자인리서치와마케팅</td><td>3</td></tr>

									<tr><td rowspan="7">3학년</td>
									<td>전선</td><td class="ta_left">공간디자인실습</td><td>3</td><td>전선</td><td class="ta_left">상업공간디자인</td><td>3</td></tr>
									...
									<tr><td>전선</td><td class="ta_left">조명디자인 I</td><td>3</td><td>전선</td><td class="ta_left">현대건축론</td><td>3</td></tr>
									<tr><td>전선</td><td class="ta_left">가구디자인론</td><td>3</td><td >전선</td><td class="ta_left r_txt">가구디자인*</td><td>3</td></tr>
									<tr><td>전선</td><td class="ta_left">실내가상현실</td><td>3</td><td >전선</td><td class="ta_left">인테리어디자인현장실습</td><td>3</td></tr>
									<tr><td>교양</td><td class="ta_left">코디네이트미학</td><td>3</td><td>전선</td><td class="ta_left">건축설비 I</td><td>3</td></tr>

									<tr><td rowspan="6">4학년</td>
									<td>전선</td><td class="ta_left">전시디자인</td><td>3</td><td>전선</td><td class="ta_left">포트폴리오</td><td>3</td></tr>
									<tr><td>전선</td><td class="ta_left">실시설계</td><td>3</td><td>전선</td><td class="ta_left">디자인세미나</td><td>3</td></tr>
									<tr><td>전선</td><td class="ta_left">디자인마케팅</td><td>3</td><td>일선</td><td class="ta_left">인테리어시공</td><td>3</td></tr>
									<tr><td>일선</td><td class="ta_left">부동산경영론</td><td>3</td><td>일선</td><td class="ta_left">부동산정보론</td><td>3</td></tr>
									<tr><td>일선</td><td class="ta_left">부동산컨설팅</td><td>3</td><td>일선</td><td class="ta_left">풍수지리 I</td><td>3</td></tr>
									<tr><td>일선</td><td class="ta_left">홈페이지설계</td><td>3</td><td>전선</td><td class="ta_left">시각디자인</td><td>3</td></tr>

									<tr><td rowspan="7">자격증</td>
									<td rowspan="7">전필</td><td class="ta_left">실내건축기사</td><td>20</td><td rowspan="7">일선</td><td class="ta_left">컬러리스트기사</td><td>20</td></tr>
									<tr><td class="ta_left">실내건축산업기사</td><td>16</td><td class="ta_left">컬러리스트산업기사</td><td>16</td></tr>
									<tr><td class="ta_left">실내디자이너</td><td>30</td><td class="ta_left">컴퓨터활용능력1급</td><td>14</td></tr>
									<tr><td class="ta_left">건축목공산업기사</td><td>16</td><td class="ta_left">컴퓨터활용능력2급</td><td>6</td></tr>
									<tr><td class="ta_left">건축목재시공기능장</td><td>30</td><td class="ta_left">워드프로세서</td><td>4</td></tr>
									<tr><td class="ta_left"></td><td></td><td class="ta_left">GTQ(그래픽기술)1급</td><td>5</td></tr>
									<tr><td class="ta_left"></td><td></td><td class="ta_left">GTQ(그래픽기술)2급</td><td>3</td></tr>
								</tbody>
							</table>
						</div>
						<div class="ta_txt">
