		...
		<div class="container">
			...
			<div class="content" id="content">
				...
				<!-- content -->
					...
					<table class="list_tbl_03" summary="고객센터 목록">
						...
						<tbody>
							<tr>
								<td>★공지★</td>
								<td class="ta_left">
									<a href="${pageContext.request.contextPath }/EgovPageLink.do?link=adm/customer/admCustomerNoti_1">
										"The requested URL was rejected. ..." 화면 관련
									</a>
								</td>
								<td>테스트관리자</td>
								<td>2017-12-08</td>
