...
<script type="text/javascript">
	...
	// 목록
	function fn_list(){
		$("#frm").attr("method", "post").attr("action", "<c:out value='${pageContext.request.contextPath }/usr/elite/interior/eliteInteriorList.do'/>").submit();
	}
	
	// 조회
	function fn_select(mbSeq){
		$("#mbSeq").val(mbSeq);
		$("#frm").attr("method", "get").attr("action", "<c:out value='${pageContext.request.contextPath }/usr/elite/interior/eliteInteriorView.do'/>").submit();
	}
	...
	function fn_select_add(){
		flag = false;
		$.ajax({
			url: "<c:out value='${pageContext.request.contextPath }/usr/elite/interior/eliteInteriorPreView.do'/>"
			, type: "get"
...
<input type="hidden" id="menuNum" name="menuNo" value="${sessionScope.menuNo }">
