			...
			<div class="content" id="content">
				...
				<!-- content -->
					...
					<table class="view_tbl_03 mb30 mt30" summary="교양수강문의">
						...
						<tbody>
							<tr class="first">
								<th scope="row" colspan="6">비학위과정 FAQ</th>
							</tr>
							<tr>
								<th scope="row">작성자</th>
								<td>관리자</td>
							...
							<tr>
								<td colspan="6">
									...
									<p>*최소 1주-최대 2주 소요</p>
									<p><strong>&nbsp;</strong></p>
									<p><strong><strong>8. </strong><strong>교육장학금 신청 </strong></strong></p>
									<p>Q. 교육장학금은 어떻게 신청하나요? 전액 지원이 가능한가요?</p>
									<p>A. 수강 종료 후, 출석률 80%의 수강생을 대상으로 수강확인서를 발급합니다.</p>
									<p>수강확인서는 한디원 교학팀에 개별 문의하시면 됩니다.</p>
									<p>다만, 교육장학금 지급의 대한 내용은 취업지원팀에서 답변이 가능합니다. 개인별로 지원 금액이 다를 수 있으니, 수강 전에 확인하시기 바랍니다.</p>
