...
<script type="text/javascript">
	...
	function fn_list(pageNo){
		$("#frm").attr("method", "post").attr("action", "<c:out value='${pageContext.request.contextPath }/qxerpynm/elite/digitalArt/admEliteDigitalArtList.do'/>").submit();
	}
	
	// 삭제
	function fn_delete(){
		if(confirm("삭제하시겠습니까?")){
			$("#frm").attr("method", "post").attr("action", "<c:out value='${pageContext.request.contextPath }/qxerpynm/elite/digitalArt/admEliteDigitalArtDelete.do'/>").submit();
	...
	//수정화면
	function fn_modify(){
		$("#frm").attr("method", "post").attr("action", "<c:out value='${pageContext.request.contextPath }/qxerpynm/elite/digitalArt/admEliteDigitalArtModify.do'/>").submit();
	}
...
<div class="wrap">
	...
	<div class="container">
		...
		<div class="content" id="content">
			...
			<!-- content -->
				<!-- table -->
				<table class="view_tbl_03 mb30 mt30" summary="성우콘텐츠크리에이터">
					<caption>성우콘텐츠크리에이터</caption>
					<colgroup>
						<col width="13%" />
						<col width="20%" />
						<col width="13%" />
