...
<script>
	...
	<c:if test="${empty majorBoardVO.mbSeq}">
		...
		$("#frm").attr("method","post").attr("action", "<c:out value='${pageContext.request.contextPath }/qxerpynm/majorBoard/digitalArt/admMajorDigitalArtUpdate.do'/>").submit();
	}
		...
		<div class="content" id="content">
			...
			<div class="title_area">
				<jsp:include page="/WEB-INF/jsp/hsDesign/adm/inc/incPageTitle.jsp">
		            ...
		            <jsp:param name="dept2" value="디지털아트(디자인)"/>
            	</jsp:include>
			</div>
			<div class="cont_box">
			<!-- content -->
				...
				<table class="view_tbl_03 mb30" summary="디지털아트(디자인)">
