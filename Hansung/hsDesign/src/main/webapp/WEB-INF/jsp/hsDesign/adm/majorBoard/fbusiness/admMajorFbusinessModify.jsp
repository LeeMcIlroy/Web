...
<script>
	...
	<c:if test="${empty majorBoardVO.mbSeq}">
		...
		$("#frm").attr("method","post").attr("action", "<c:out value='${pageContext.request.contextPath }/qxerpynm/majorBoard/fbusiness/admMajorFbusinessUpdate.do'/>").submit();
	}
	...
	<div class="container">
		...
		<div class="content" id="content">
			...
			<!-- content -->
				...
				<table class="view_tbl_03 mb30" summary="패션비즈니스">
