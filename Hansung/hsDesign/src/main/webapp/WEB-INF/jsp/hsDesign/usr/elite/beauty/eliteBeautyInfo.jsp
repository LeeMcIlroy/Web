		...
		<div class="width_box">
			...
			<div class="sub_content">
				...
				<jsp:include page="/WEB-INF/jsp/hsDesign/usr/inc/incPageTitle2.jsp">
		            ...
		            <jsp:param name="dept3" value="뷰티교육자"/>
				...
				<div class="sub_cont_page">
					<dl class="info_dl">
						...
						<dd>
							<p style="margin-top: 30px;text-align: center;"><img src="<c:out value='${pageContext.request.contextPath }/assets/usr/img/elite/beautyEducator.jpg'/>" /></p>
						</dd>
					</dl>
				</div>
