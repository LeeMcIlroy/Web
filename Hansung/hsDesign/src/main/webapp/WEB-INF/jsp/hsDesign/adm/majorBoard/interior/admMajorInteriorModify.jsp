...
<script>
	...
	<c:if test="${empty majorBoardVO.mbSeq}">
		...
		$("#frm").attr("method","post").attr("action", "<c:out value='${pageContext.request.contextPath }/qxerpynm/majorBoard/interior/admMajorInteriorUpdate.do'/>").submit();
	}
	
	// 목록으로 이동
	function fn_list(){
		$("#frm").attr("method", "post").attr("action", "<c:out value='${pageContext.request.contextPath }/qxerpynm/majorBoard/interior/admMajorInteriorList.do'/>").submit();
	}
