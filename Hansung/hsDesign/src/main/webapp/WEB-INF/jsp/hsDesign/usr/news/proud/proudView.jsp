...
<script type="text/javascript">
	...
	// 목록
	function fn_list(){
		$("#frm").attr("method", "post").attr("action", "<c:out value='${pageContext.request.contextPath }/usr/news/proud/proudList.do'/>").submit();
	}
	...
	function fn_select(cbSeq){
		...
		$("#frm").attr("method","get").attr("action", "<c:out value='${pageContext.request.contextPath }/usr/news/proud/proudView.do'/>").submit();
	}
		...
		<div class="width_box">
			...
			<div class="sub_content">
				...
				<jsp:include page="/WEB-INF/jsp/hsDesign/usr/inc/incPageTitle.jsp">
		            ...
		            <jsp:param name="dept2" value="자랑스런 한디원"/>
	           	</jsp:include>
	           	<div id="viewPage">
