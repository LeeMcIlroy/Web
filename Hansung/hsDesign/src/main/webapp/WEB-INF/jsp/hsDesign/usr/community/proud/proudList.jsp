...
<script type="text/javascript">
	...
	function fn_select(cbSeq){
		...
		$("#frm").attr("action", "<c:out value='${pageContext.request.contextPath }/usr/community/proud/proudView.do'/>?cbSeq="+cbSeq).submit();
	}
			...
			<div class="width_box">
				...
				<div class="sub_content">
					<c:import url="/EgovPageLink.do?link=usr/inc/incPageTitle">
						...
						<c:param name="dept2" value="한디원 이슈"/>
					</c:import>
					<div class="top_tab type_li2">
						<ul>
							...
							<li <c:if test="${searchVO.menuType eq '0701' }">class="active"</c:if> ><a href="<c:out value='${pageContext.request.contextPath }/usr/community/exhibit.do'/>">공모전 수상</a></li>
						</ul>
					</div>
					<%-- 
					<div class="list_sh">
