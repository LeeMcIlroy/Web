...
<script type="text/javascript">
	...
	function fn_update(){
		...
		$("#frm")
				...
				.attr(
						"action",
						"<c:out value='${pageContext.request.contextPath }/usr/enter/consult/consultUpdate.do'/>")
				.submit();
	}
</script>
<body>
				...
				<jsp:include page="/WEB-INF/jsp/hsDesign/usr/inc/incPageTitle.jsp">
	           	...
	           	<div class="transform_table notice_type">
					<div class="tbl_write">
						...
						<ul class="tbl_view_m">
							<li class="txt_left">* 구분</li>
							<li>
								<form:select path="cbType">
									<form:option value="0101">입학</form:option>
									<form:option value="0102">편입</form:option>
								</form:select>
							</li>
						</ul>
