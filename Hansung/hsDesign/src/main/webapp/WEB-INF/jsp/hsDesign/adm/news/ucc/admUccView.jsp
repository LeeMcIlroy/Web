	...
	<div class="wrap">
		...
		<div class="container">
			...
			<div class="content" id="content">
				...
				<!-- content -->
					<!-- table -->
					<table class="view_tbl_03 mb30 mt30" summary="작품동영상&amp;UCC">
							...
							<tr>
								<td colspan="6">
										<video poster="http://placehold.it/640x360" width="640" height="360" controls="controls">
											<source src="https://youtu.be/R2xWN0YDA8c" type="video/mp4" />
											<source src="https://youtu.be/R2xWN0YDA8c" type="video/webm" />
										</video>
										...
										<p><c:out value="${cmmBoardVO.cbContent }" escapeXml="false"/></p>
									</div>
								</td>
							</tr>
							 --%>
