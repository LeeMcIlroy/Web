...
<script type="text/javascript">
	...
	function fn_list(pageNo){
		...
		$("#frm").attr("method", "post").attr("action", "<c:out value='${pageContext.request.contextPath }/usr/community/oveServ/oveServList.do'/>").submit();
	}
	...
	function fn_select(cbSeq){
		...
		$("#frm").attr("action", "<c:out value='${pageContext.request.contextPath }/usr/community/oveServ/oveServView.do'/>?cbSeq="+cbSeq).submit();
	}
			...
			<div class="width_box">
				...
				<div class="sub_content">
	           	...
	           	<div class="top_tab type_li2">
					<ul>
						<li><a href="<c:out value='${pageContext.request.contextPath }/usr/community/oveServ/oveServ.do'/>">해외봉사 안내</a></li>
						<li class="active"><a href="<c:out value='${pageContext.request.contextPath }/usr/community/oveServ/oveServList.do'/>">해외봉사 보고서</a></li>
					</ul>
				</div>
