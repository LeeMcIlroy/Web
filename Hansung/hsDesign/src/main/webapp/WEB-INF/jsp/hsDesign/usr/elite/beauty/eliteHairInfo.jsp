		...
		<div class="width_box">
			...
			<div class="sub_content">
				...
				<jsp:include page="/WEB-INF/jsp/hsDesign/usr/inc/incPageTitle2.jsp">
		            ...
		            <jsp:param name="dept3" value="하야시두피모발"/>
				...
				<div class="sub_cont_page">
					<dl class="info_dl">
						...
						<dd>
							<p style="margin-top: 30px;text-align: center;"><img src="<c:out value='${pageContext.request.contextPath }/assets/usr/img/elite/hayashi.jpg'/>" /></p>
						</dd>
					</dl>
				</div>
