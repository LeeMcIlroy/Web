...
<script type="text/javascript">
	...
	function fn_select(cbSeq){
		...
		$("#frm").attr("method","get").attr("action", "<c:out value='${pageContext.request.contextPath }/usr/community/festival/festivalView.do'/>").submit();
	}
		...
		<div class="width_box">
			...
			<div class="sub_content">
				...
				<jsp:include page="/WEB-INF/jsp/hsDesign/usr/inc/incPageTitle.jsp">
		            ...
		            <jsp:param name="dept2" value="한디원 행사"/>
	           	</jsp:include>
	           	<div id="viewPage">
