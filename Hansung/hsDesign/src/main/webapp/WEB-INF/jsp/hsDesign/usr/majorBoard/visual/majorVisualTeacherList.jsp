...
<script type="text/javascript">
	function fn_list(searchType){
		...
		$("#frm").attr("action", "<c:out value='${pageContext.request.contextPath}/usr/majorBoard/visual/majorVisualTeacherList.do'/>").submit();
	}
</script>
<body>
		...
		<div class="sub_content">
			...
			<div class="top_tab type_li5">
				<ul>
					...
					<li <c:if test="${searchVO.searchType eq '시각·패키지디자인' }"> class="active" </c:if>><a href="#" onclick="fn_list('시각·패키지디자인'); return false;">시각·패키지디자인</a></li>
					<li <c:if test="${searchVO.searchType eq '광고·브랜드디자인' }"> class="active" </c:if>><a href="#" onclick="fn_list('광고·브랜드디자인'); return false;">광고·브랜드디자인</a></li>
					<li <c:if test="${searchVO.searchType eq '일러스트레이션'}"> class="active" </c:if>><a href="#" onclick="fn_list('일러스트레이션'); return false;">일러스트레이션</a></li>
					<li <c:if test="${searchVO.searchType eq '웹UX·UI디자인' }"> class="active" </c:if>><a href="#" onclick="fn_list('웹UX·UI디자인'); return false;">웹UX·UI디자인</a></li>
				</ul>
			</div>
			<div class="pro_info">
