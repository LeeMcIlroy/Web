...
<script type="text/javascript">
	...
	function fn_list(pageNo){
		...
		$("#frm").attr("method", "post").attr("action", "<c:out value='${pageContext.request.contextPath }/usr/general/exper/experNewsList.do'/>").submit();
	}

	// 조회
	function fn_select(mbSeq){
		$("#mbSeq").val(mbSeq);
		$("#frm").attr("method", "get").attr("action", "<c:out value='${pageContext.request.contextPath }/usr/general/exper/experNewsView.do'/>").submit();
	}
