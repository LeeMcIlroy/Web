...
<script type="text/javascript">
	...
	function fn_delete(){
		if(confirm("삭제하시겠습니까?")){
			$("#frm").attr("method", "post").attr("action", "<c:out value='${pageContext.request.contextPath }/qxerpynm/majorBoard/visual/admMajorVisualDelete.do'/>").submit();
	...
	//수정화면
	function fn_modify(){
		$("#frm").attr("method", "post").attr("action", "<c:out value='${pageContext.request.contextPath }/qxerpynm/majorBoard/visual/admMajorVisualModify.do'/>").submit();
	}
...
<div class="wrap">
	...
	<div class="container">
		...
		<div class="content" id="content">
			...
			<!-- content -->
				<!-- table -->
				<table class="view_tbl_03 mb30 mt30" summary="시각디자인">
