			...
			<div class="sub_content">
				...
				<jsp:include page="/WEB-INF/jsp/hsDesign/usr/inc/incPageTitle2.jsp">
					<jsp:param name="dept1" value="전공"/>
		           		 <jsp:param name="dept2" value="디지털아트학(디자인)"/>
		           		 <jsp:param name="dept3" value="교과과정"/>
	           	</jsp:include>
				<div class="top_tab type_li2">
					<ul>
						<li <c:if test="${searchVO.menuType eq '01' }">class="active"</c:if> ><a href="<c:out value='${pageContext.request.contextPath }/usr/majorBoard/digitalArt/majorDigitalArtCourse.do?menuType=01'/>">교과 과정</a></li>
						<li <c:if test="${searchVO.menuType eq '02' }">class="active"</c:if> ><a href="<c:out value='${pageContext.request.contextPath }/usr/majorBoard/digitalArt/majorDigitalArtCourse.do?menuType=02'/>">교과목 개요</a></li>
					</ul>
				</div>
							...
							<div class="ta_overbox">
								...
								<tbody>
									...
									<tr>
										<td rowspan="8">2학년</td>
										<td>교양</td>
										<td class="ta_left">코디네이터미학</td>
										<td>3</td>
										<td>교양</td>
										<td class="ta_left r_txt">중국문화의 이해*</td>
										<td>3</td>
									</tr>
									<tr>
										<td>일선</td>
										<td class="ta_left">화술 I</td>
										<td>3</td>
										<td>일선</td>
										<td class="ta_left">기초연기 I</td>
										<td>3</td>
									</tr>
									<tr>
										<td>전필</td>
									...
									<tr>
										<td>전선</td>
										<td class="ta_left">영상디자인스튜디오I</td>
										<td>3</td>
										<td>전선</td>
										<td class="ta_left">인터페이스디자인</td>
										<td>3</td>
									...
									<tr>
										...
										<td>3</td>
										<td>일선</td>
										<td class="ta_left">만화배경학</td>
										<td>3</td>
									</tr>
									<tr>
										<td>일선</td>
										<td class="ta_left">화술 II</td>
										<td>3</td>
										<td>전선</td>
										<td class="ta_left">컴퓨터애니메이션</td>
										<td>3</td>
									...
									<tr>
										<td>일선</td>
										<td class="ta_left">즉흥연기II</td>
										<td>3</td>
										<td>일선</td>
										<!--<td class="ta_left">일러스트레이션I</td>-->
										<td class="ta_left">게임캐릭터디자인</td>
										<td>3</td>
									</tr>
									<tr>
										<td>전선</td>
									...
									<tr>
										<td>전선</td>
										<td class="ta_left">디지털영상</td>
										<td>3</td>
										<td>전선</td>
										<td class="ta_left">모션그래픽</td>
										<td>3</td>
									</tr>
									<tr>
										<td>전필</td>
										<td class="ta_left">제작실습II</td>
										<td>3</td>
										<td>전필</td>
									...
									<tr>
										...
										<td>3</td>
										<td>일선</td>
										<td class="ta_left">라디오연기실습</td>
										<td>3</td>
									</tr>
									<tr>
										<td>일선</td>
										<td class="ta_left">TV연기실습 I</td>
										<td>3</td>
										<td>일선</td>
									...
									<tr>
										<td>전선</td>
										<td class="ta_left">디지털미디어프로덕션스튜디오 II</td>
										<td>3</td>
										<td>전선</td>
