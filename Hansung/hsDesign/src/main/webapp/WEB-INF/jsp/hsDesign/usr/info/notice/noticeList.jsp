...
<script type="text/javascript">
	...
	function fn_list(pageNo){
		...
		$("#frm").attr("method", "post").attr("action", "<c:out value='${pageContext.request.contextPath }/usr/info/notice/noticeList.do'/>").submit();
	}
	
	// 조회
	function fn_select(cbSeq){
		$("#frm").attr("action", "<c:out value='${pageContext.request.contextPath }/usr/info/notice/noticeView.do'/>?cbSeq="+cbSeq).submit();
	}
