...
public class EgovUserDetailsHelper {
	...
	*/
	...
	public static String getAuthenticatedAdminId() {
		...
		AdminVO adminVO = (AdminVO) object;
		return adminVO.getAdminId();
	}

	//관리자:회사코드
	public static String getAuthenticatedAdminCorpCd() {
		Object object = getAuthenticatedAdmin();
		if(object==null){
			return "";
		}
		AdminVO adminVO = (AdminVO) object;
		return adminVO.getCorpCd();
	}
	
	//관리자:지사코드
	public static String getAuthenticatedAdminBranchCd() {
		Object object = getAuthenticatedAdmin();
		if(object==null){
			return "";
		}
		AdminVO adminVO = (AdminVO) object;
		return adminVO.getBranchCd();
	}
	
	//관리자:지사코드
	public static String getAuthenticatedAdminEmpNo() {
		Object object = getAuthenticatedAdmin();
		if(object==null){
			return "";
		}
		AdminVO adminVO = (AdminVO) object;
		return adminVO.getEmpNo();
	}
	...
	public static String getAuthenticatedUserId() {
		...
		Sb1000mVO sb1000mVO = (Sb1000mVO) object;
		return sb1000mVO.getUserId();
	}
	
	//사용자:회사코드
	public static String getAuthenticatedCorpCd() {
		Object object = getAuthenticatedUser();
		if(object==null){
			return "";
		}
		Sb1000mVO sb1000mVO = (Sb1000mVO) object;
		return sb1000mVO.getCorpCd();
	}
	
	//사용자:연구대상자번호 
	public static String getAuthenticatedRsjNo() {
		Object object = getAuthenticatedUser();
		if(object==null){
			return "";
		}
		Sb1000mVO sb1000mVO = (Sb1000mVO) object;
		return sb1000mVO.getRsjNo();
	}
