...
public class EgovComUtlController {
	...
	public String moveToPage(@RequestParam("link") String linkPage){
		...
		LOGGER.debug("linkPage= "+linkPage);
		link = link.replace(";", "");
		link = link.replace(".", "");
		...
		if (linkPage==null || linkPage.equals("")){
			...
			link="src/main/webapp/common/error.jsp";
		}
		
		// test 
		//LOGGER.debug("egovWhitelist.toString()= "+egovWhitelist.toString());
		//LOGGER.debug("linkPage= "+linkPage);
