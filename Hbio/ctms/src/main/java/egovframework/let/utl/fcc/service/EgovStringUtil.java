...
/**
	...
	/**
	 * 검색조건의 년도를 구해오는 메서드
	 * 기준년도(startYear)를 기준으로 현재 년도 + 1 년도까지 구해올수 있음
	 * 구해온 정보는 HashMap 에 value, name 형태로 저장되고 이 HashMap들을 ArrayList에 담아서 반환한다.
	 * 사용 목적은 StringUtil 의 getSelectionOption 메서드에 넘겨줄 ArrayList 를 생성하는데 있다.
	 * 년도의 정렬 순서로 정렬
	 * 최초작성자 : 이규호, 작성일 : 2020.12.07
	 * @param startYear
	 * @return						<code>ArrayList</code>
	 */
	public static List<EgovMap> getYearOptionListDesc(int startYear)
	{
		...
		List<EgovMap> optionList = new ArrayList<EgovMap>();
	...
	/**
	 * SMS 예약발송의 예약일을 구해오는 메서드
	 * 
	 * 최초작성자 : 이규호, 작성일 : 2021.01.29
	 * @param date
	 * @return						<code>ArrayList</code>
	 */
	public static String getSmsDate(String date, String hour, String min){
		String rmDate = removeMinusChar(date);
		String lpHour = setLPad(hour, 2, "0");
		String lpmin = setLPad(min, 2, "0");
		String result = rmDate + lpHour + lpmin + "00";
