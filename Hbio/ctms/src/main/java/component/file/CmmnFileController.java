...
//	public String downloadFile(@RequestParam String fileId, HttpServletRequest request, HttpServletResponse response) throws Exception {
	public String downloadFile(@RequestParam String fileId, @RequestParam String type, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		Ct7000mVO attachVO = cmmDAO.selectAttachOne(fileId);
	...
	private String pdfOpen(String fileId, HttpServletRequest request, HttpServletResponse response ) throws Exception{
		...
		String filePath = (String) attachVO.getRegFileName();
		String fileName = (String) attachVO.getOrgFileName();
...
//	public String downloadFile(@RequestParam String fileId, HttpServletRequest request, HttpServletResponse response) throws Exception {
	...
	@RequestMapping("/cmmn/file/pdfView.do")
	public Map<String,String> pdfView(@RequestParam String attachSeq, @RequestParam String type, HttpServletRequest request, HttpServletResponse response) throws Exception {
		LOGGER.debug("파일 미리보기! : "+attachSeq);
		
		String result = "";
		String filePath = "";
		String fileName = "";
		Ct7000mVO attachVO = cmmDAO.selectAttachOne(attachSeq);
		filePath = attachVO.getRegFileName();
		fileName = attachVO.getOrgFileName();
