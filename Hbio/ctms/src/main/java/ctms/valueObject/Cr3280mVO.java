...
public class Cr3280mVO {

    private String    corpCd               = ""; // 회사코드
    private String    rsNo                 = ""; // 연구과제번호
    private String    termType             = ""; // 시험시기 사전 1 사후2
	...
	public String toString() {
		return "Cr3280mVO [corpCd=" + corpCd + ", rsNo=" + rsNo + ", termType=" + termType + ", rsiNo=" + rsiNo
				+ ", var1=" + var1 + ", var2=" + var2 + ", var3=" + var3 + ", var4=" + var4 + ", var5=" + var5
				+ ", var6=" + var6 + ", var7=" + var7 + ", var8=" + var8 + ", var9=" + var9 + ", var10=" + var10
				+ ", var11=" + var11 + ", var12=" + var12 + ", var13=" + var13 + ", var14=" + var14 + ", var15=" + var15
				+ ", dataRegdt=" + dataRegdt + ", dataRegnt=" + dataRegnt + ", rsNo7=" + rsNo7 + ", tempNo=" + tempNo
				+ "]";
	}
