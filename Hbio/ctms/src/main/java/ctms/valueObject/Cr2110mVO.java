...
public class Cr2110mVO {
    ...
    private String upageCnt             = ""; // 구성쪽수
    private String fileKey              = ""; // 파일첨부키
	...
	public String toString() {
		return "Cr2110mVO [corpCd=" + corpCd + ", rsNo=" + rsNo + ", rsName=" + rsName + ", tempNo=" + tempNo
				+ ", svSeq=" + svSeq + ", svCnt=" + svCnt + ", title=" + title + ", content=" + content + ", svStdt="
				+ svStdt + ", svEndt=" + svEndt + ", mtCls=" + mtCls + ", mtClsNm=" + mtClsNm + ", dataRegdt="
				+ dataRegdt + ", dataRegnt=" + dataRegnt + ", tempType=" + tempType + ", upageCnt=" + upageCnt
				+ ", fileKey=" + fileKey + "]";
	}
