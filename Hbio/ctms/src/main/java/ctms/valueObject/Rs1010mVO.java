...
public class Rs1010mVO {
    ...
    private String mkCls				= ""; // CRF진행단계 1030 승인완료
	...
	public String toString() {
		return "Rs1010mVO [corpCd=" + corpCd + ", rsNo=" + rsNo + ", rsNo1=" + rsNo1 + ", rsNo2=" + rsNo2 + ", rsNo2Nm="
				...
				+ rsirbDt + ", rsrStdt=" + rsrStdt + ", rsrEndt=" + rsrEndt + ", rep2Dt=" + rep2Dt + ", mrsNo=" + mrsNo
				+ ", doutCnt=" + doutCnt + ", mkCls=" + mkCls + "]";
	}
