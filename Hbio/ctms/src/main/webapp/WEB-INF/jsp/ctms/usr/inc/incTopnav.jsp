...
<%
	Sb1000mVO adminVO = ((Sb1000mVO)session.getAttribute("usrSession")!=null)?(Sb1000mVO)session.getAttribute("usrSession"):null;
%>
<div class="header background01">
	<div class="header_con">
		<h1>H&amp;Bio 피부임상연구센터</h1>
		<div class="util">
			<a href="<c:out value='${pageContext.request.contextPath }/usr/login/logout.do'/>" title="로그아웃">로그아웃</a>
		</div>
		<div class="gnb">
			<ul>
			<% if("Y".equals(adminVO.getHplogin())){ %>
				<li><a href="<c:out value='${pageContext.request.contextPath }/usr/ecf0101/ecf0101List.do'/>">참여일정</a></li>
		...
		<div class="gnb_mobile">
			...
			<div id="main-sidebar">
				<div class="sidebar_top">
					...
					<div class="util_logout"><a href="<c:out value='${pageContext.request.contextPath }/usr/login/logout.do'/>" title="로그아웃">로그아웃</a></div>
...
<%-- 					<li><a href="<c:out value='${pageContext.request.contextPath }/usr/ecf0101/ecf0101List.do'/>">참여일정</a></li>
		...
		<p>H&Bio 피부임상연구센터는<span>전문성과 신뢰성 기반의 세계 일류 인체적용시험 기관입니다</span></p>
