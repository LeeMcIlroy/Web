...
<script type="text/javascript">
	function fn_view(){
		location.href = "<c:out value='${pageContext.request.contextPath }/qxsepmny/tmp/ech070402.do'/>";
	}
</script>
<body>
<!-- wrap -->
	...
	<div class="container">
		...
		<div class="contents">
			...
			<table class="tbl_list tr_link">
				...
				<tbody>
					<tr>
						<td class="nodata" colspan="9">고객사 정보가 없습니다.</td>
					</tr>
					<tr onclick="fn_view(); return fasle;">
						<td>3</td>
						<td>ㅇㅇ주식회사</td>						
						<td>홍길동</td>						
						<td>123-45-67890</td>
