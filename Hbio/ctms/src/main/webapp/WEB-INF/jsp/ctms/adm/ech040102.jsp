...
<script type="text/javascript">
	function fn_view(){
		location.href = "<c:out value='${pageContext.request.contextPath }/qxsepmny/tmp/ech040103.do'/>";
	}
	...
	<div class="container">
		...
		<div class="contents">
            ...
            <div class="tab_area tab06">
                <ul>
                	<li><a href="#" class="on">동의서</a></li>
                	<li><a href="#" onclick="fn_view(); return false;">eCRF통계</a></li>
                	<li><a href="#">피부특성</a></li>
                	<li><a href="#">피부자극</a></li>
                	<li><a href="#">제품사용</a></li>
			...
			<table class="tbl_list">
				...
				<tbody>
					<tr>
						<td class="nodata" colspan="7">동의서 정보가 없습니다.</td>
					</tr>
					<tr>
						<td>3</td>					
						<td>홍길동</td>
					...
					<tr>
						...
						<td>00</td>
						<td>남</td>						
						<td><a href="#" onclick="fn_pop_icf1(); return false;" class="btn_sub">출력</a></td>
						<td><a href="#" onclick="fn_pop_icf2(); return false;" class="btn_sub">출력</a></td>
					</tr>
					<tr>
						<td>1</td>					
						<td>홍길동</td>
