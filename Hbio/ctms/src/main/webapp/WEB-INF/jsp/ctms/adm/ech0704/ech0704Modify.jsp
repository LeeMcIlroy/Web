					...
					<tbody>
						...
						<tr>
							...
							<td>
								...
								<form:input path="cregno2" class="p30" onKeyup="this.value=this.value.replace(/[^0-9]/g,'');" maxlength="7"/>
							</td>
						</tr>
						...
						<tr>							
							<th scope="row">비고</th>
							<td colspan="3">
								<textarea class="type02 type03" id="remk" name="remk"><c:out value="${ct2000mVO.remk }" /></textarea>
							</td>
						</tr>
						<tr>							
