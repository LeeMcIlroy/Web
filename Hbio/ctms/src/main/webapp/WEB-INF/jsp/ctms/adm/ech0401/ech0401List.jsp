...
<script type="text/javascript">
	...
	function fn_view(corpCd, rsNo){		
	 	$("#corpCd").val(corpCd);
	 	$("#rsNo").val(rsNo);
	 	$("#listForm").attr("action","<c:url value='/qxsepmny/ech0401/ech0401ViewCrf.do'/>").submit();
	}
			...
			<table class="tbl_list tr_link">
				...
				<c:forEach var="result" items="${resultList}" varStatus="status">
					<tr>					
						...
						<td><c:out value="${result.rsInfor }"/><br><c:out value="${result.rsInforScnt }"/></td>
