...
<script type="text/javascript">
	function fn_view(){
		location.href = "<c:out value='${pageContext.request.contextPath }/qxsepmny/tmp/ech040105.do'/>";
	}
	
	function fn_pop(){
		window.open("<c:out value='${pageContext.request.contextPath }/qxsepmny/tmp/ech040404.do'/>"
	...
	<div class="container">
		...
		<div class="contents">
			...
			<jsp:include page="/WEB-INF/jsp/ctms/adm/inc/incPageTitle.jsp">
	            ...
	            <jsp:param name="dept2" value="시험결과추출(피부특성)"/>
           	</jsp:include>
            ...
            <div class="tab_area tab06">
                <ul>
                	...
                	<li><a href="#" class="on">피부특성</a></li>
                	<li><a href="#" onclick="fn_view(); return false;">피부자극</a></li>
                	<li><a href="#">제품사용</a></li>
			...
			<div class="tbl_top_info">
				...
				<!-- 버튼 -->
				<div>
					<a href="#" class="btn_sub">피부특성 전체통계 출력</a>
				</div>
			</div>
			<!-- //테이블 상단 정보 -->
            <!-- 목록 -->
			<table class="tbl_list">
				...
				<tbody>
					<tr>
						<td class="nodata" colspan="6">피부특성 정보가 없습니다.</td>
					</tr>
					<tr>
						<td>3</td>	
						<td>홍길동</td>					
