...
<script type="text/javascript">
	function fn_view(){
		location.href = "<c:out value='${pageContext.request.contextPath }/qxsepmny/tmp/ech020102.do'/>";
	}	
</script>
<body>
<!-- wrap -->
	...
	<div class="container">
		...
		<div class="contents">
			...
			<jsp:include page="/WEB-INF/jsp/ctms/adm/inc/incPageTitle.jsp">
	            ...
	            <jsp:param name="dept2" value="eCRF관리"/>
           	</jsp:include>
			<!-- //타이틀 -->
			<!-- 검색영역 -->
			<div class="srch_area">
			...
			<table class="tbl_list tr_link">
				...
				<tbody>
					<tr>
						<td class="nodata" colspan="8">eCRF관리 정보가 없습니다.</td>
					</tr>
