...
<script type="text/javascript">
	function fn_view(){
		location.href = "<c:out value='${pageContext.request.contextPath }/qxsepmny/tmp/ech030102.do'/>";
	}
</script>
<body>
<!-- wrap -->
			...
			<div class="srch_area">
				<ul>
                    ...
                    <li>
						<p>참여연구</p>
						<span>
							<input type="radio" name="partResearch" id="partResearchY" />
							<label for="partResearchY">Y</label>
							<input type="radio" name="partResearch" id="partResearchN" />
							<label for="partResearchN">N</label>
						</span>
					</li>
					<li>
						<p>기간</p>
			...
			<table class="tbl_list">
				...
				<thead>
					<tr>
                        ...
                        <th scope="col">연구참여</th>
                        <th scope="col">관리자확인일</th>
                        <th scope="col">메모</th>                        
					</tr>
				</thead>
				<tbody>
					<tr>
						<td class="nodata" colspan="13">피험자 정보가 없습니다.</td>
					</tr>
					<tr onclick="fn_view(); return false;">
						...
						<td>1</td>
						<td>0000-00-00</td>
						<td><a href="#" class="btn_sub">확인</a></td>
					</tr>
					<tr onclick="fn_view(); return false;">
						<td><input type="checkbox" /></td>
						<td>2</td>
