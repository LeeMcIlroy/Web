...
<script type="text/javascript">
	...
	function fn_step(){
		if(confirm('대상자의 스크리닝 예약정보를 저장합니다.\r\n저장하시겠습니까?')){
			...
			$.ajax({
				url: "<c:url value='${pageContext.request.contextPath }/qxsepmny/ech0102/ech0102AjaxSaveAllScr.do'/>"
				, type: "post"
				, data: "corpCd="+corpCd+"&"+"rsNo="+rsNo+"&"+"resrDt="+resrDt+"&"+"resrHr="+resrHr+"&"+"resrMm="+resrMm+"&"+"mtSt="+mtSt+"&"+"mtCnt="+mtCnt+"&"+"resrNo="+resrNo+"&"+"regDt="+regDt+"&"+$("input[name=rsjSeq]:checked").serialize()
				, dataType:"json"
				, success: function(data){
					alert(data.message);
					window.opener.fn_view2(5);
					window.close();
				}, error: function(){
					alert("오류가 발생하였습니다.");
				}
