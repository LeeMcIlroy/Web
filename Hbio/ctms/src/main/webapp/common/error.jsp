...
<title>FactCTMS</title>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta http-equiv="X-UA-Compatible" content="IE=edge" />
<meta http-equiv="Content-Script-Type" content="text/javascript" />
<meta http-equiv="Content-Style-Type" content="text/css" />
<meta name="viewport" content="width=device-width, initial-scale=1, minimum-scale=1, maximum-scale=2, user-scalable=yes" />
<meta name="keywords" content="FactCTMS" />
...
<body class="error">
	<div class="error_wrap">
		<div class="er_cts">
			...
			<div class="er_btn">
				<a href="#" onclick="javascript: history.back(-1); return false;" class="hgbtn green01">FactCTMS로 돌아가기</a>
			</div>

			<p class="er_copy">COPYRIGHT(C) FactCTMS. ALL RIGHTS RESERVED.</p>
		</div>
	</div>
