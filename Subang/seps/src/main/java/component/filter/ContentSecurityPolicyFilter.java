...
public class ContentSecurityPolicyFilter implements Filter {
    ...
    public void init(FilterConfig filterConfig) throws ServletException {
        ...
        */
        ...
        String originLocationRef = "'self' https://kapi.kakao.com/;";
...
//        cspPolicies.add("img-src " + originLocationRef);
        ...
        cspPolicies.add("frame-src 'self' http://www.smartway.seoul.kr/ http://smartway.seoul.go.kr/m/StatMap.view https://kapi.kakao.com/;");
