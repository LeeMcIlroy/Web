...
<script type="text/javascript">
	...
	function fn_select(noticeId){
		...
		$("#frm").attr("method", "post").attr("action", "<c:out value='${pageContext.request.contextPath}/adm/floodCenter/noticeView.do'/>").submit();
	}
											...
											<td class="tal_l tint_10">
												<a href="#" onclick="fn_select(<c:out value='${result.noticeId }'/>); return false;">
													...
													<c:if test="${!empty result.attachFileId }">
														&nbsp;&nbsp;<img src="<c:out value='${pageContext.request.contextPath}/assets/img/ico_file.png'/>" alt="첨부파일" />
													</c:if>
												</a>
											</td>
