...
(
	...
	YEARLY					VARCHAR(4) NULL, -- 2018.09.28 전년대비로 체크 THIS : 당해년도 , LAST : 전년대비
	YEARLY_YEAR				VARCHAR(4) NOT NULL,
...
(
	...
	PRIMARY KEY ( PLAN_MONTHLY_INVEST_SEQ, SEQ)
);
...
(
	...
	FINANCIAL_COST			DECIMAL(12, 2) NOT NULL,	-- 순금융비용(2018.09.03)
	FCF2					DECIMAL(12, 2) NOT NULL,	-- FCF2

	F_ALLOCATION			DECIMAL(12, 2) NOT NULL,	-- 배당(2018.09.14 . 재무 상세 정보가 있어야 해서 추가)
	F_INCREASE				DECIMAL(12, 2) NOT NULL,	-- 증자(2018.09.14 . 재무 상세 정보가 있어야 해서 추가)
	F_BORROWING				DECIMAL(12, 2) NOT NULL,	-- 차입(2018.09.14 . 재무 상세 정보가 있어야 해서 추가)
	F_REPAYMENT				DECIMAL(12, 2) NOT NULL,	-- 상환(2018.09.14 . 재무 상세 정보가 있어야 해서 추가)
	F_ETC					DECIMAL(12, 2) NOT NULL,	-- 기타(2018.09.14 . 재무 상세 정보가 있어야 해서 추가)

	FINANCIAL_SUM			DECIMAL(12, 2) NOT NULL,	-- 재무 활동 소계
	CASH_SUM				DECIMAL(12, 2) NOT NULL,	-- 현금흐름합계(2018.09.03)
...
(
	...
	INVENTORY				DECIMAL(12, 2) NOT NULL,
	INVENTORY_TO_DAYS		DECIMAL(12, 2) NOT NULL,	--*[2018-09-03] 데이터가 없어 NOT NULL -> NULL 로 변경
...
-- 엑셀 파일 업로드 이력 관리(개발 미 반영) : HALLA_PM_ADMIN 반영
...
(
	...
	COMP_KOR_NAME			NVARCHAR(1000) NULL,
	DEPT_KOR_NAME			NVARCHAR(1000) NULL,
	CREATE_DATE				DATETIME NULL,
