...
{
    public class PlanYearBsExAdmin : BaseInfo
    {
        ...
        public List<int> planYearBsBsheetSeq { get; set; }
        ...
        public List<int> PlanYearBsRoicSeq { get; set; }
        ...
        public List<string> BsCapitalYearlyMonth { get; set; }
        public List<int> PlanYearBsWCapitalSeq { get; set; }
        ...
        public List<int> PlanYearBsCapitalRegSeq { get; set; }
        public List<string> BsCapitalRegYearlyYear { get; set; }
        public List<string> BsCapitalRegYearlyMonth { get; set; }
        ...
        public List<int> PlanYearBsSummarySeq { get; set; }
