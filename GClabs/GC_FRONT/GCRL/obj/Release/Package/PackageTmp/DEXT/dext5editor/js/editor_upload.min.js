...
function upload_Drop(a){document.getElementById("drop_zone").style.border="dashed 1px gray";document.getElementById("drop_zone").style.backgroundColor="#FFFFFF";var c=document.getElementById("drop_zone_uploadtype").value;G_dragDropFileObj=a.dataTransfer.files;fileOnchange(G_dragDropFileObj,c);switch(c){default:document.getElementById("file_text").value=a.dataTransfer.files[0].name,document.getElementById("file_text").setAttribute("value",a.dataTransfer.files[0].name),document.getElementById("file_text_view")&&
