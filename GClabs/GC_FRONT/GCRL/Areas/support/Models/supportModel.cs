...
namespace GCRL.Areas.support.Models
{
    public class supportBoardModel
    {
    ...
    public class supportListModel : supportBoardModel
    {

    }

    public class supportViewModel : supportBoardModel
    {
