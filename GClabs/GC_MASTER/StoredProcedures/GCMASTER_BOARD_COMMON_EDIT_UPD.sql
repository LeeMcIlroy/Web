...
/*======================================================================
    PROGRAM     [GCMASTER_BOARD_COMMON_EDIT_UPD]
    AUTHOR      AnSeongYeol
    DATE        2022-02-02
    EDIT        
======================================================================
...
======================================================================*/
ALTER PROCEDURE [dbo].[GCMASTER_BOARD_COMMON_EDIT_UPD]
(
    @TYPE               VARCHAR(3),
    @IDX                INT,
...
BEGIN
    ...
    UPDATE  dbo.BOARD_COMMON
        SET     VIEW_ORDER  = @VIEW_ORDER,
                ...
                TITLE       = @TITLE,
                CONTENT_S   = ISNULL(@CONTENT_S, ''),
                CONTENT_F   = @CONTENT_F,

                DIV_CODE1   = ISNULL(@DIV_CODE1, ''),
                DIV_CODE2   = ISNULL(@DIV_CODE2, ''),
                DIV_VALUE1  = ISNULL(@DIV_VALUE1, ''),
                DIV_VALUE2  = ISNULL(@DIV_VALUE2, ''),
                DIV_DATE1   = ISNULL(@DIV_DATE1, ''),

                IMAGE1_ORG_NAME    = @IMAGE1_ORG_NAME,
                IMAGE1_SAVE_NAME   = @IMAGE1_SAVE_NAME,
                IMAGE1_SIZE        = @IMAGE1_SIZE,

                IMAGE2_ORG_NAME    = @IMAGE2_ORG_NAME,
                IMAGE2_SAVE_NAME   = @IMAGE2_SAVE_NAME,
                IMAGE2_SIZE        = @IMAGE2_SIZE,

                ATTACH1_ORG_NAME    = @ATTACH1_ORG_NAME,
                ATTACH1_SAVE_NAME   = @ATTACH1_SAVE_NAME,
                ATTACH1_SIZE        = @ATTACH1_SIZE,
